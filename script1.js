setInterval(showTime, 1000);
        ...
        function myom1(){
			...
			document.getElementById("i9").innerText="Wake Up Time:5AM-8AM <br>Lunch Time:default<br>Nap Time:default<br>Night Time:default";
			}
				...
				document.getElementById("i9").innerText="Wake Up Time:default<br>Lunch Time:12PM-5PM<br>Nap Time:default<br>Night Time:default";
			}
				...
				document.getElementById("i9").innerText="Wake Up Time:default <br>Lunch Time:default<br>Nap Time:5PM-9PM<br>Night Time:default";
			}
				...
				document.getElementById("i9").innerText="Wake Up Time:default <br>Lunch Time:default<br>Nap Time:default<br>Night Time:9PM-5AM";
			}
}
